# NO BORRAR — cascaron pre-montado de `pintarron`

Este repo existe para que, el dia de la mudanza, la liga vieja
`https://alexpueblag.github.io/pintarron/` no muera ni un minuto.

Ese dia se renombra a `pintarron` y toma su lugar **ya construido**.
...
retirado el nombre `pintarron` por trafico, en cuyo caso esa direccion
